...
let s:p.normal.left = [ [ s:black, s:blue ], [ s:violet, s:black ] ]
let s:p.normal.right = [ [ s:violet, s:black ], [ s:violet, s:black ], [ s:violet, s:black ] ]
let s:p.inactive.right = [ [ s:black, s:black2 ], [ s:gray, s:black ] ]
let s:p.inactive.left =  [ [ s:gray, s:black ], [ s:black2, s:black ] ]
let s:p.insert.left = [ [ s:black, s:green ], [ s:violet, s:black ] ]
let s:p.replace.left = [ [ s:black, s:red ], [ s:violet, s:black2 ] ]
...
let s:p.tabline.left = [ [ s:violet, s:black ] ]
let s:p.tabline.tabsel = [ [ s:none, s:black ] ]
let s:p.tabline.middle = [ [ s:violet, s:black ] ]
